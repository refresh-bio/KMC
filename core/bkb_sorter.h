...
class CBigKmerBinSorter_Impl<CKmer<SIZE>, SIZE> {
	...
	static void PreCompactKxmers(CBigKmerBinSorter<CKmer<SIZE>, SIZE>& ptr, uint64& compacted_count,
								 uint32* counters);
	static uint64 FindFirstSymbOccur(CBigKmerBinSorter<CKmer<SIZE>, SIZE> &ptr, uint64 start_pos, uint64 end_pos,
									 uint32 offset, uchar symb);
	static void InitKXMerSet(CBigKmerBinSorter<CKmer<SIZE>, SIZE> &ptr, uint64 start_pos, uint64 end_pos,
...
//----------------------------------------------------------------------------------
template<typename KMER_T, unsigned SIZE>
CBigKmerBinSorter<KMER_T, SIZE>::CBigKmerBinSorter(CKMCParams& Params,
		CKMCQueues& Queues) : kxmer_set(Params.kmer_len) {
	sorted_kxmers = NULL;
	kxmer_counters = NULL;
	bbkq = Queues.bbkq;
	bbspq = Queues.bbspq;
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinSorter_Impl<CKmer<SIZE>, SIZE>::PostProcessKmers(
	CBigKmerBinSorter<CKmer<SIZE>, SIZE>& ptr) {
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinSorter_Impl<CKmer<SIZE>, SIZE>::PreCompactKxmers(
	CBigKmerBinSorter<CKmer<SIZE>, SIZE>& ptr, uint64& compacted_count, uint32* counters) {
	compacted_count = 0;
	CKmer<SIZE> *act_kmer;
...
template <unsigned SIZE> uint64 CBigKmerBinSorter_Impl<CKmer<SIZE>, SIZE>::FindFirstSymbOccur(
	CBigKmerBinSorter<CKmer<SIZE>, SIZE> &ptr, uint64 start_pos, uint64 end_pos, uint32 offset, uchar symb) {
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinSorter_Impl<CKmer<SIZE>, SIZE>::InitKXMerSet(
	CBigKmerBinSorter<CKmer<SIZE>, SIZE> &ptr, uint64 start_pos, uint64 end_pos, uint32 offset, uint32 depth) {
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinSorter_Impl<CKmer<SIZE>, SIZE>::PostProcessKxmers(
	CBigKmerBinSorter<CKmer<SIZE>, SIZE>& ptr) {
	ptr.kxmer_set.clear();
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinSorter_Impl<CKmer<SIZE>, SIZE>::PostProcessSort(
	CBigKmerBinSorter<CKmer<SIZE>, SIZE>& ptr) {
	if (ptr.max_x)
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinSorter_Impl<CKmerQuake<SIZE>, SIZE>::PostProcessSort(
	CBigKmerBinSorter<CKmerQuake<SIZE>, SIZE>& ptr) {
