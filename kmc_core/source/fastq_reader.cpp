...
CFastqReader::CFastqReader(CMemoryMonitor *_mm, CMemoryPool *_pmm_fastq, input_type _file_type,
						   uint32 _gzip_buffer_size, uint32 _bzip2_buffer_size, int _kmer_len) {
	mm		  = _mm;
