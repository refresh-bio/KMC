...
CC 	= g++
CFLAGS	= -Wall -g -m64 -static -Wl,--whole-archive -lpthread -Wl,--no-whole-archive -std=c++11
CLINK	= -lm -static  -Wl,--whole-archive -lpthread -Wl,--no-whole-archive -std=c++11

KMC_TOOLS_CFLAGS	= -Wall  -m64 -static -Wl,--whole-archive -lpthread -Wl,--no-whole-archive -std=c++14
KMC_TOOLS_CLINK	= -lm -static  -Wl,--whole-archive -lpthread -Wl,--no-whole-archive -std=c++14

KMC_OBJS = \
$(KMC_MAIN_DIR)/kmer_counter.o \
$(KMC_MAIN_DIR)/mmer_compartator.o \
$(KMC_MAIN_DIR)/mmer.o \
