...
template<typename KMER_T, unsigned SIZE> CBigKmerBinUncompactor<KMER_T, SIZE>::CBigKmerBinUncompactor(
	CKMCParams& Params, CKMCQueues& Queues) {
...
//----------------------------------------------------------------------------------
template<typename KMER_T, unsigned SIZE> void CBigKmerBinUncompactor<KMER_T, SIZE>::Uncompact(int32 _bin_id,
		uchar* _data, uint64 _size) {
	bin_id = _bin_id;
	input_data = _data;
...
//----------------------------------------------------------------------------------
template <unsigned SIZE> inline void CBigKmerBinUncompactor_Impl<CKmer<SIZE>, SIZE>::GetNextSymb(uchar& symb,
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinUncompactor_Impl<CKmer<SIZE>, SIZE>::ExpandKxmersBoth(
	CBigKmerBinUncompactor<CKmer<SIZE>, SIZE>& ptr) {
	uchar* _raw_buffer;
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinUncompactor_Impl<CKmer<SIZE>, SIZE>::ExpandKxmersAll(
	CBigKmerBinUncompactor<CKmer<SIZE>, SIZE>& ptr) {
	uchar* _raw_buffer;
	ptr.sm_pmm_expand->reserve(_raw_buffer);
	ptr.kxmers = (CKmer<SIZE>*)_raw_buffer;
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinUncompactor_Impl<CKmer<SIZE>, SIZE>::ExpandKmersBoth(
	CBigKmerBinUncompactor<CKmer<SIZE>, SIZE>& ptr) {
	uchar* _raw_buffer;
	ptr.sm_pmm_expand->reserve(_raw_buffer);
	ptr.kxmers = (CKmer<SIZE>*)_raw_buffer;
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinUncompactor_Impl<CKmer<SIZE>, SIZE>::ExpandKmersAll(
	CBigKmerBinUncompactor<CKmer<SIZE>, SIZE>& ptr) {
	uchar* _raw_buffer;
	ptr.sm_pmm_expand->reserve(_raw_buffer);
	ptr.kxmers = (CKmer<SIZE>*)_raw_buffer;
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinUncompactor_Impl<CKmer<SIZE>, SIZE>::Uncompact(
	CBigKmerBinUncompactor<CKmer<SIZE>, SIZE>& ptr) {
	if (ptr.max_x) {
		if (ptr.both_strands)
...
//----------------------------------------------------------------------------------
template<unsigned SIZE> void CBigKmerBinUncompactor_Impl<CKmerQuake<SIZE>, SIZE>::Uncompact(
	CBigKmerBinUncompactor<CKmerQuake<SIZE>, SIZE>& ptr) {
